      ...
      <Card>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {supportingReports.map((r) => (
            // NOTE: these are illustrative sample IDs from mock pattern data, not real
            // report documents in MongoDB — intentionally not clickable/navigable.
            // See openReport() in useNavigation for the real, backend-backed report IDs.
            <div
              key={r.id}
              style={{
                display: "flex",
