...
// Mongo ObjectId = 24 hex chars. Anything else (e.g. mock IDs like "OIL-2026-1804")
// can never match a real report, so short-circuit before hitting Prisma at all.
...
router.get("/:id", async (req, res) => {
  try {
    ...
    // Not a valid Mongo ObjectId (e.g. a stale/mock ID like "OIL-2026-1804")
    // -> it's a 404, not a DB error. Never send it to Prisma.
